...
class SprintsControllerTest < ActionController::TestCase
  ...
  test "should create sprint" do
    assert_difference('Sprint.count') do
      post :create, sprint: { description: @sprint.description, name: @sprint.name, project_id: @sprint.project_id }
    end
  ...
  test "should update sprint" do
    put :update, id: @sprint, sprint: { description: @sprint.description, name: @sprint.name, project_id: @sprint.project_id }
    assert_redirected_to sprint_path(assigns(:sprint))
  end
