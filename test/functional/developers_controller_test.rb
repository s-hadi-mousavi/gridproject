...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { address: @developer.address, comment: @developer.comment, email: @developer.email, name: @developer.name, nit: @developer.nit, phone: @developer.phone, web: @developer.web }
    end
  ...
  test "should update developer" do
    put :update, id: @developer, developer: { address: @developer.address, comment: @developer.comment, email: @developer.email, name: @developer.name, nit: @developer.nit, phone: @developer.phone, web: @developer.web }
    assert_redirected_to developer_path(assigns(:developer))
  end
